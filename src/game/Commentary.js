...
const Commentary = ({commentary}) => {
    return (
        <div
            className="mdl-cell mdl-grid mdl-grid--no-spacing">
            <div
                className="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
